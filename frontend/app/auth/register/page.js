...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const mockUser = {
        ...
        walletAddress: formData.walletAddress || '0x742d35Cc6634C0532925a3b8D4C0532925a3b8D4',
        registered: true,
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      if (!isAllowed) {
        setError('Freighter wallet extension is not installed. Please install it to continue.');

  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center space-x-2 text-sm text-gray-400">
        ...
        <span className="text-white">{token.username.toUpperCase()}</span>
      </nav>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-400 text-lg">{token.username.toUpperCase()}</span>
              {token.isVerified && (
            ...
            <div className="flex items-center space-x-4 mt-1">
              <div className="flex items-center space-x-1 text-sm text-gray-400">
                ...
                <span>Karma Score: {formatNumber(token.karmaScore)}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-end space-x-6">
        ...
        <div className="flex items-center space-x-3 pb-1">
          ...
          <div className={`text-lg ${isPositive ? 'text-green-400' : 'text-red-400'}`}>
            {isPositive ? '+' : ''}{formatPrice(token.priceChange24h)}
          </div>
        </div>
      </div>
    </div>
